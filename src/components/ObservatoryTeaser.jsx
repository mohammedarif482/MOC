            ...
            <div className="max-w-container mx-auto px-6 lg:px-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <p className="text-muted text-xs uppercase tracking-widest mb-4">The Deep End</p>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium leading-tight mb-6">
                            We Think About More Than Products.{' '}
                            <span className="font-cursive italic">This Is MOC Thinking Out Loud.</span>
                        </h2>
                        <p className="text-muted text-base leading-relaxed mb-8">
                            Essays on psychology, product philosophy, human behavior,
                            and the deeper questions behind why things work — or don't.
                        </p>
                        <Link to="/the-observatory" className="inline-flex items-center gap-2 text-white text-sm font-medium border border-white/20 px-6 py-3 hover:bg-white/5 transition-colors">
                    ...
                    <div>
                        <motion.div
                            ...
                            className="mb-12"
                        >
                            <p className="text-xs text-dim uppercase tracking-widest mb-4">Featured Essay</p>
                            ...
                            <Link to="/the-observatory" className="inline-flex items-center gap-1.5 text-white text-sm font-medium hover:text-muted transition-colors">
                                Read the Essay <ArrowRight className="w-3.5 h-3.5" />
                            </Link>
                        </motion.div>

                        <div className="border-t border-white/10 pt-8">
                            <p className="text-xs text-dim uppercase tracking-widest mb-6">More From the Observatory</p>
                            {essays.map((essay, i) => (
                                <motion.div
                                    key={i}
                                    ...
                                    viewport={{ once: true }}
                                >
                                    <Link to="/the-observatory" className="group flex items-center gap-3 py-4 border-b border-white/5 hover:border-white/10 transition-colors">
                                        <ArrowRight className="w-3.5 h-3.5 text-dim group-hover:text-white shrink-0 transition-colors" />
                                        <span className="text-muted text-sm group-hover:text-white transition-colors">{essay}</span>
                                    </Link>
                                </motion.div>
                            ))}
                        </div>
