...
const products = [
    {
        ...
        description: 'Know exactly where your business is leaking. Cross-department KPI tracking, AI-powered insights, built for founders who need clarity — not more noise.',
        link: '/documentations',
    },
    {
        number: '02',
        ...
        description: 'Content intelligence for Instagram. Analyze your past content, benchmark competitors, get data-backed ideas, hooks, and scripts that have a reason to work.',
        link: '/documentations',
    },
    {
        number: '03',
        ...
        description: 'Built for local businesses that want fast delivery without rebuilding their entire operation. Plugs into existing billing software. Ships fast.',
        link: '/documentations',
    },
];
        ...
        <section className="bg-black py-24 lg:py-32 border-t border-white/10">
            <div className="max-w-container mx-auto px-6 lg:px-10">
                <motion.div
                    ...
                    className="mb-6"
                >
                    <p className="text-muted text-xs uppercase tracking-widest mb-4">Our Products</p>
                    ...
                    <Link to="/infinity-canvas" className="inline-flex items-center gap-2 text-white text-sm font-medium border border-white/20 px-6 py-3 hover:bg-white/5 transition-colors">
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                    viewport={{ once: true }}
                    className="mt-12 flex items-center justify-center gap-3 py-6 border-t border-white/5"
                >
                    <span className="relative flex h-2 w-2">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75" />
                        <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500" />
                    </span>
                    <span className="text-muted text-sm">Something new is being researched.</span>
                    <Link to="/mission-studies" className="inline-flex items-center gap-1.5 text-white text-sm font-medium hover:text-muted transition-colors">
                        Follow it live <ArrowRight className="w-3.5 h-3.5" />
                    </Link>
                </motion.div>
            </div>
        </section>
