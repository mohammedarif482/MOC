        ...
        <section className="bg-black py-24 lg:py-32 border-t border-white/10">
            <div className="max-w-container mx-auto px-6 lg:px-10">
                ...
                >
                    ...
                    <Link to="/impact-studies" className="inline-flex items-center gap-2 text-white text-sm font-medium border border-white/20 px-6 py-3 hover:bg-white/5 transition-colors">
                        View All Impact Studies <ArrowRight className="w-4 h-4" />
                    </Link>
                </motion.div>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10">
                    {studies.map((study, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <Link to="/impact-studies" className="group block bg-black p-8 lg:p-12 h-full hover:bg-white/[0.02] transition-colors">
                                ...
                                <p className="text-white text-lg lg:text-xl font-medium leading-snug mb-8">{study.result}</p>
