...
const articles = [
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?w=600&h=340&fit=crop',
    },
];
        ...
        <section className="bg-black py-24 lg:py-32 relative overflow-hidden">
            ...
            <div className="max-w-container mx-auto px-6 lg:px-10 relative z-10">
                ...
                <motion.div
                    ...
                    className="mb-6"
                >
                    <p className="text-muted text-xs uppercase tracking-widest mb-4">From the Lab</p>
                ...
                <motion.div
                    ...
                    className="mt-20"
                >
                    <p className="text-xs text-dim uppercase tracking-widest mb-6">Featured</p>

                    <Link to="/mission-studies" className="group block border border-white/10 hover:border-white/20 transition-all overflow-hidden">
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div className="p-8 lg:p-12 flex flex-col justify-center">
                                <p className="text-xs text-muted uppercase tracking-wider mb-4">Gap Report — March 2026</p>
                                <h3 className="text-2xl lg:text-3xl font-medium text-white leading-tight mb-6 group-hover:text-muted transition-colors">
                                ...
                                <div className="flex items-center gap-4 text-xs text-dim">
                                    ...
                                    <span className="inline-flex items-center gap-1.5 text-white group-hover:text-muted transition-colors">
                        ...
                        >
                            <Link to="/mission-studies" className="group block border border-white/10 hover:border-white/20 transition-all overflow-hidden">
                                ...
                                <div className="p-6 lg:p-8">
                                    <h4 className="text-white text-lg font-medium leading-snug mb-4 group-hover:text-muted transition-colors">
                                        {article.title}
                                    </h4>
                                    <div className="flex items-center gap-3 text-xs text-dim">
                                        ...
                                        <ArrowRight className="w-4 h-4 text-dim group-hover:text-white ml-auto transition-colors" />
                                    </div>
                                </div>
                            </Link>
                        </motion.div>
